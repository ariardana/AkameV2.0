...
module.exports = akame = async (akame, m, chatUpdate, store) => {
    try {
        ...
        //buttons Tambahan
        const ntiktok = ('')  //ubah di config biar ngk emror
